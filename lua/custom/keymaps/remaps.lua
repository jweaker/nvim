...
vim.keymap.set({ 'n', 't' }, '<C-M-l>', [[<Cmd>wincmd ><CR>]])
vim.keymap.set({ 'n', 't' }, '<C-M-h>', [[<Cmd>wincmd <<CR>]])
vim.keymap.set({ 'n', 't' }, '<C-M-k>', [[<Cmd>wincmd -<CR>]])
vim.keymap.set({ 'n', 't' }, '<C-M-j>', [[<Cmd>wincmd +<CR>]])
